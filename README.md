...
- `VITE_CONTACT_API_URL`: contact form API endpoint. Supports either a full `/api/contact` URL or a service base URL (the app appends `/api/contact` automatically when needed).
