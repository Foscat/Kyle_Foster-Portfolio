...
export default function Head() {
  ...
  useLayoutEffect(() => {
    // React 19 owns runtime metadata, so remove the static build tags after the first client commit to prevent duplicates.
  ...
  return (
    <>
      ...
      {/* React 19 does not hoist inline JSON-LD, so keep route-aware structured data in the document head explicitly. */}
      {createPortal(
