        ...
        <FlexboxGrid justify="center" className="contact-grid">
          <FlexboxGrid.Item colspan={20} className="contact-grid-item">
              ...
              header={
                <header>
                  <div className="contact-page__copy">
                    <h1>{contactFormSchema.title || "Contact"}</h1>
                    <p>
                      I&apos;m a Senior React / Frontend Engineer. I build polished frontend
                      systems, clear user flows, and maintainable React interfaces. Reach out for
                      roles, freelance work, collaborations, or technical discussions.
                    </p>
                  </div>
            ...
            >
              ...
              <SectionRenderer key={formResetNonce} section={contactFormSection} />
            </Panel>
          </FlexboxGrid.Item>
        </FlexboxGrid>
        <Footer />
