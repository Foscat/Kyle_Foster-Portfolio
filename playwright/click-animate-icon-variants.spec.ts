/**
 * @file playwright\click-animate-icon-variants.spec.ts
 * @description playwright\click-animate-icon-variants.spec module.
 * @module playwright\click-animate-icon-variants.spec
 */
